...
const getGroupByCreatedByPaginated = (pageIndex, pageSize) => {
    const config = {
        method: 'GET',
        url: `${groupsApi.endpoint}/createdby/paginate?pageIndex=${pageIndex}&pageSize=${pageSize}`,
        withCredentials: true,
        crossdomain: true,
        headers: { 'Content-Type': 'application/json' },
    };
...
const deleteJoinedGroup = (groupId) => {
    const config = {
        method: "DELETE",
        url: `${groupsApi.endpoint}/deletejoin/${groupId}`,
        crossdomain: true,
        headers: { 'Content-Type': 'application/json' },
    };
    return axios(config).then(() => {
...
const joinGroup = (payload) => {
    const config = {
        method: 'POST',
        url: `${groupsApi.endpoint}/joingroup`,
        data: payload,
        withCredentials: true, 
        crossdomain: true,
        headers: { 'Content-Type': 'application/json' },
...
const getJoinedGroup = (groupId) => {
    const config = {
        method: 'GET',
        url: `${groupsApi.endpoint}/joingroup/${groupId}`,
        withCredentials: true,
        crossdomain: true,
        headers: { 'Content-Type': 'application/json' },
    };

...
const locationsFormSchema = Yup.object().shape({
    ...
    lineOne: Yup.string().min(2, 'Address Line One must be more than 2 characters').max(255, 'Address Line One cannot exceed 255 characters').required('Select your address from the suggestions'),

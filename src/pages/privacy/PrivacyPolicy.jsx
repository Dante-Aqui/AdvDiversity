            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-md-8 col-md-offset-2">
                        <div>
                            <div id="AD-privacy-policy">
                                <h1 className="text-align-center padding-top-2em">Privacy Policy</h1>
                                ...
                                <div className="col-11 center">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <p>
                                                <strong>Company</strong> refers to Adv. Diversity Enterprises, Inc., 400
                                                Corporate Pointe, Suite 300, Culver City, CA 90230.
                                            </p>
                                        </li>
                                        <li>
                                            <p>
                                        ...
                                        <li>
                                            <p>
                                                <strong>Website</strong> refers to Adv. Diversity Coding Bootcamp,
                                                accessible from www.Adv. Diversity.la
                                            </p>
                                        </li>
                                        <li>
                                            <p>
                                    ...
                                    <p>
                                        Usage Data may include information such as Your Device Internet Protocol address
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            For more information on how You can delete Flash Cookies available at:
                                        </li>
                                        <li>
                                    ...
                                    <p>
                                        ...
                                        are deleted as soon as You close Your web browser. You can learn more about
                                    ...
                                    <p>
                                        ...
                                        You click on a third party link, You will be directed to that third partys site.
                                    ...
                                    <p>
                                        ...
                                        to the change becoming effective and update the Last updated date at the top of
                                        this Privacy Policy.
                                    </p>
                                    <p>
                                    ...
                                    <ul>
                                        <li>
                                            By email: <a href="mailto:info@info.com">info@info.com</a>
                                        </li>
                                    </ul> */}
                                </div>
                            </div>

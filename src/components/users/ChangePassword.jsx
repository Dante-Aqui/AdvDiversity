...
function ChangePassword() {
    ...
    const handleSubmit = (values) => {
        ...
        usersServices.changePassword(values).then(changePasswordSuccess).catch(changePasswordError);
    };
                                        ...
                                        {({ values, errors, touched }) => (
                                            <Form>
                                                ...
                                                <div className="form-group mb-3">
                                                    By clicking the <strong>Change Password</strong> button below you
                                                    will be changing your password.
                                                </div>

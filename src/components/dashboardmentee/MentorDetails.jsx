...
const MentorDetails = (mentor) => {
    ...
    const onLocalPersonClicked = () => {
        getEmailPerson(mentor)
    }

    const getEmailPerson = (emailToRetrieve) => {
        _logger(emailToRetrieve.props.email)
        setEmailPerson(emailToRetrieve.props.email);
    }
                    ...
                    <Card.Body key={mentor.props.id} useridkey={mentor.props.userId}>
                        ...
                        <div className="mt-1 mb-1">
                            <div className="font-13">
                                <strong>{mentor.props.email}</strong>
                            </div>
                            <div className="font-13 ">
                        ...
                        <Button onClick={openCalendlyPersonData}>Create Appointment</Button>
                        <Modal
                            isOpen={modalIsOpen}

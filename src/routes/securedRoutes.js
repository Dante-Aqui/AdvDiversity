...
const MentorDashboard = lazy(() => import('../pages/dashboard/mentors/MentorDashboard'));
const EventWizard = lazy(() => import('../components/events/EventWizard'));
const Events = lazy(() => import('../components/events/Events'));
const JobFairWizard = lazy(() => import('../components/jobfairs/JobFairWizard'));
const PageNotFound = lazy(() => import('../pages/error/PageNotFound'));
const Resources = lazy(() => import(`../components/resources/admin/Resources`));
const ResourcesForm = lazy(() => import(`../components/resources/admin/ResourcesForm`));
...
const SurveyAnalytics = lazy(() => import('../components/surveys/SurveyAnalytics'));
...
const OrganizationDashboard = lazy(() => import('../pages/dashboard/organization/OrganizationDashboardPage'));
const NewslettersForm = lazy(() => import('../components/newsletters/NewsletterForm'));
...
const jobFairRoutes = [
    {
        path: '/dashboard/jobfairs/create',
        name: 'JobFairWizard',
        exact: true,
        element: JobFairWizard,
        roles: ['Admin', 'Mentor'],
        isAnonymous: false,
    },
];
...
const mentorRoutes = [
    ...
    },
    {
        ...
        name: 'Mentor Dashboard Secured Route',
        exact: true,
